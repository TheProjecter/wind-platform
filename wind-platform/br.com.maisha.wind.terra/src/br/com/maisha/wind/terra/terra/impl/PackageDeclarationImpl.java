...
public class PackageDeclarationImpl extends MinimalEObjectImpl.Container implements PackageDeclaration {
	...
	protected EClass eStaticClass() {
		return TerraPackageImpl.Literals.PACKAGE_DECLARATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerraPackageImpl.PACKAGE_DECLARATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerraPackageImpl.PACKAGE_DECLARATION__NAME:
				return getName();
		}
