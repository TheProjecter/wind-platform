...
import br.com.maisha.wind.terra.terra.impl.TerraPackageImpl;
 ...
 * <!-- end-user-doc -->
 * @see br.com.maisha.wind.terra.terra.impl.TerraPackageImpl
 * @generated
 */
public class TerraSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TerraPackageImpl modelPackage;
	...
	public TerraSwitch() {
		if (modelPackage == null) {
			modelPackage = TerraPackageImpl.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TerraPackageImpl.DOMAIN_OBJECT: {
				DomainObject domainObject = (DomainObject)theEObject;
				T result = caseDomainObject(domainObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.IMPORT: {
				Import import_ = (Import)theEObject;
				T result = caseImport(import_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.PACKAGE_DECLARATION: {
				PackageDeclaration packageDeclaration = (PackageDeclaration)theEObject;
				T result = casePackageDeclaration(packageDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.OBJECT_PROPERTY: {
				ObjectProperty objectProperty = (ObjectProperty)theEObject;
				T result = caseObjectProperty(objectProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.ATTRIBUTE_PROPERTY: {
				AttributeProperty attributeProperty = (AttributeProperty)theEObject;
				T result = caseAttributeProperty(attributeProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.OPERATION_PROPERTY: {
				OperationProperty operationProperty = (OperationProperty)theEObject;
				T result = caseOperationProperty(operationProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.VALIDATION: {
				Validation validation = (Validation)theEObject;
				T result = caseValidation(validation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.ARRAY: {
				Array array = (Array)theEObject;
				T result = caseArray(array);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerraPackageImpl.VALIDATION_RULE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operation Property</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operation Property</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperationProperty(OperationProperty object) {
		return null;
	}
