...
/**
 * Manual modifications go to {br.com.maisha.wind.TerraRuntimeModule}
 */
...
public abstract class AbstractTerraRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "br/com/maisha/wind/Terra.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("br.com.maisha.wind.Terra");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return br.com.maisha.wind.services.TerraGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return br.com.maisha.wind.serializer.TerraSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return br.com.maisha.wind.serializer.TerraSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return br.com.maisha.wind.parser.antlr.TerraParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return br.com.maisha.wind.parser.antlr.TerraAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return br.com.maisha.wind.parser.antlr.internal.InternalTerraLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<br.com.maisha.wind.parser.antlr.internal.InternalTerraLexer> provideInternalTerraLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(br.com.maisha.wind.parser.antlr.internal.InternalTerraLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(br.com.maisha.wind.parser.antlr.internal.InternalTerraLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends br.com.maisha.wind.validation.TerraJavaValidator> bindTerraJavaValidator() {
		return br.com.maisha.wind.validation.TerraJavaValidator.class;
	}

	// contributed by org.eclipse.xtext.generator.scoping.AbstractScopingFragment
	public Class<? extends org.eclipse.xtext.scoping.IScopeProvider> bindIScopeProvider() {
		return br.com.maisha.wind.scoping.TerraScopeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.generator.IGenerator> bindIGenerator() {
		return br.com.maisha.wind.generator.TerraGenerator.class;
	}

	// contributed by org.eclipse.xtext.generator.formatting.FormatterFragment
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return br.com.maisha.wind.formatting.TerraFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return br.com.maisha.wind.jvmmodel.TerraJvmModelInferrer.class;
	}
