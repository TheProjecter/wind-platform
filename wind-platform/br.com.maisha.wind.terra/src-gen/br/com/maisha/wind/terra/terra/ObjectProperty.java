 ...
 * </p>
 *
 * @see br.com.maisha.wind.terra.terra.TerraPackage#getObjectProperty()
 * @model
 * @generated
 */
public interface ObjectProperty extends EObject
{
   ...
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getObjectProperty_Name()
   * @model
   * @generated
   */
   ...
   * @see #setValue(String)
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getObjectProperty_Value()
   * @model
   * @generated
   */
  String getValue();
