 ...
 * <ul>
 *   <li>{@link br.com.maisha.wind.terra.impl.ValidationRuleImpl#getMessageKey <em>Message Key</em>}</li>
 *   <li>{@link br.com.maisha.wind.terra.impl.ValidationRuleImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValidationRuleImpl extends MinimalEObjectImpl.Container implements ValidationRule
{
  ...
  {
    return TerraPackage.Literals.VALIDATION_RULE;
  }
  ...
  public void setMessageKey(String newMessageKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TerraPackage.VALIDATION_RULE__MESSAGE_KEY, oldMessageKey, messageKey));
  }
  ...
  public void setExpression(String newExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TerraPackage.VALIDATION_RULE__EXPRESSION, oldExpression, expression));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TerraPackage.VALIDATION_RULE__MESSAGE_KEY:
        return getMessageKey();
      case TerraPackage.VALIDATION_RULE__EXPRESSION:
