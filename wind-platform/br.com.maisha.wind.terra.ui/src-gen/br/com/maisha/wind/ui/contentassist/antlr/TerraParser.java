		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDomainObjectAccess().getGroup_2(), "rule__DomainObject__Group_2__0");
					...
					put(grammarAccess.getDomainObjectAccess().getNameAssignment_2_1(), "rule__DomainObject__NameAssignment_2_1");
					put(grammarAccess.getDomainObjectAccess().getLabelAssignment_2_2(), "rule__DomainObject__LabelAssignment_2_2");
					put(grammarAccess.getDomainObjectAccess().getPropertiesAssignment_2_4(), "rule__DomainObject__PropertiesAssignment_2_4");
					put(grammarAccess.getDomainObjectAccess().getAttributesAssignment_3(), "rule__DomainObject__AttributesAssignment_3");
					put(grammarAccess.getDomainObjectAccess().getOperationsAssignment_4(), "rule__DomainObject__OperationsAssignment_4");
					put(grammarAccess.getDomainObjectAccess().getValidationsAssignment_5(), "rule__DomainObject__ValidationsAssignment_5");
