...
* generated by Xtext
*/
package br.com.maisha.wind.terra.ui.refactoring;
 ...
 */
public class TerraRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new TerraRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected TerraRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
