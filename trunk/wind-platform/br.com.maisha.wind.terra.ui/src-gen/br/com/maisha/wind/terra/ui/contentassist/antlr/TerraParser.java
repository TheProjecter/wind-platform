...
* generated by Xtext
*/
package br.com.maisha.wind.terra.ui.contentassist.antlr;
...
public class TerraParser extends AbstractContentAssistParser {
	...
	@Override
	protected br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraParser createParser() {
		br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraParser result = new br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDomainObjectAccess().getPackageAssignment_0(), "rule__DomainObject__PackageAssignment_0");
					put(grammarAccess.getDomainObjectAccess().getImportsAssignment_1(), "rule__DomainObject__ImportsAssignment_1");
					put(grammarAccess.getDomainObjectAccess().getNameAssignment_3(), "rule__DomainObject__NameAssignment_3");
					put(grammarAccess.getDomainObjectAccess().getLabelAssignment_4(), "rule__DomainObject__LabelAssignment_4");
					put(grammarAccess.getDomainObjectAccess().getPropertiesAssignment_6(), "rule__DomainObject__PropertiesAssignment_6");
					put(grammarAccess.getDomainObjectAccess().getAttributesAssignment_7(), "rule__DomainObject__AttributesAssignment_7");
					put(grammarAccess.getDomainObjectAccess().getOperationsAssignment_8(), "rule__DomainObject__OperationsAssignment_8");
					put(grammarAccess.getDomainObjectAccess().getValidationsAssignment_9(), "rule__DomainObject__ValidationsAssignment_9");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraParser typedParser = (br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraParser) parser;
