...
/**
 * Manual modifications go to {br.com.maisha.wind.terra.ui.TerraUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractTerraUiModule extends DefaultUiModule {
	
	public AbstractTerraUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(br.com.maisha.wind.terra.parser.antlr.internal.InternalTerraLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return br.com.maisha.wind.terra.ui.labeling.TerraLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(br.com.maisha.wind.terra.ui.labeling.TerraDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return br.com.maisha.wind.terra.ui.outline.TerraOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return br.com.maisha.wind.terra.ui.quickfix.TerraQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.JavaBasedContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return br.com.maisha.wind.terra.ui.contentassist.TerraProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return br.com.maisha.wind.terra.ui.contentassist.antlr.TerraParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(br.com.maisha.wind.terra.ui.contentassist.antlr.internal.InternalTerraLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.refactoring.IRenameStrategy.Provider> bindIRenameStrategy$Provider() {
		return br.com.maisha.wind.terra.ui.refactoring.TerraRenameStrategy.Provider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return br.com.maisha.wind.terra.ui.contentassist.antlr.PartialTerraContentAssistParser.class;
	}
