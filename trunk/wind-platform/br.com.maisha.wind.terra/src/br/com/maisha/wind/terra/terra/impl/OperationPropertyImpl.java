 ...
 * <ul>
 *   <li>{@link br.com.maisha.wind.terra.terra.impl.OperationPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link br.com.maisha.wind.terra.terra.impl.OperationPropertyImpl#getValidValues <em>Valid Values</em>}</li>
 *   <li>{@link br.com.maisha.wind.terra.terra.impl.OperationPropertyImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationPropertyImpl extends MinimalEObjectImpl.Container implements OperationProperty {
	...
	protected EClass eStaticClass() {
		return TerraPackageImpl.Literals.OPERATION_PROPERTY;
	}
	...
	public void setName(OperationPropertyName newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerraPackageImpl.OPERATION_PROPERTY__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetValidValues(Array newValidValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES, oldValidValues, newValidValues);
	...
	public void setValidValues(Array newValidValues) {
		if (newValidValues != validValues) {
			...
			if (validValues != null)
				msgs = ((InternalEObject)validValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES, null, msgs);
			if (newValidValues != null)
				msgs = ((InternalEObject)newValidValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES, null, msgs);
			msgs = basicSetValidValues(newValidValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES, newValidValues, newValidValues));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerraPackageImpl.OPERATION_PROPERTY__VALUE, oldValue, value));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerraPackageImpl.OPERATION_PROPERTY__NAME:
				return getName();
			case TerraPackageImpl.OPERATION_PROPERTY__VALID_VALUES:
				return getValidValues();
			case TerraPackageImpl.OPERATION_PROPERTY__VALUE:
				return getValue();
		}
