 ...
 * </p>
 *
 * @see br.com.maisha.wind.terra.terra.TerraPackage#getOperation()
 * @model
 * @generated
 */
public interface Operation extends EObject
{
   ...
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getOperation_Type()
   * @model
   * @generated
   */
   ...
   * @see #setName(String)
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getOperation_Name()
   * @model
   * @generated
   */
  String getName();
   ...
   * @see #setLabel(String)
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getOperation_Label()
   * @model
   * @generated
   */
  String getLabel();
   ...
   * @see br.com.maisha.wind.terra.terra.TerraPackage#getOperation_Properties()
